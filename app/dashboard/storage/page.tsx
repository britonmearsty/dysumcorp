...
export default function StoragePage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-foreground tracking-tight">Storage</h1>
      ...
      <div className="bg-card rounded-xl border border-border p-6 shadow-sm">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {/* Google Drive */}
          <div className="bg-muted rounded-xl p-6 border border-border hover:shadow-md transition-shadow">
