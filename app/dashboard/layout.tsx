  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {launchOfferAvailable && (
        <div className="w-full bg-indigo-600 dark:bg-indigo-700">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-[1800px] py-2.5 flex items-center justify-between gap-4">
            ...
            <Link
              className="shrink-0 flex items-center gap-1.5 text-xs font-bold bg-white text-indigo-700 hover:bg-indigo-50 px-3 py-1.5 rounded-lg transition-colors"
      ...
      {isEarlyAccessUser && access?.expiresAt && (
        <div className="w-full bg-indigo-600 dark:bg-indigo-700">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-[1800px] py-2.5 flex items-center justify-between gap-4">
            ...
            <Link
              className="shrink-0 text-xs font-bold text-white hover:text-indigo-200 underline underline-offset-2 transition-colors"
              href="/dashboard/billing?tab=plans"
            >
              Manage Plan
            </Link>
